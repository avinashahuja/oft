...
EXPERIMENT_NAME=$EXPET_TIME"train-benchmark-8gpu-wDLProf-wAMP"
EXPT_BATCH_SIZE=40
EXPT_NUM_DATA_LOADERS=16
EXPT_NUM_EPOCHS=1
dlprof --mode=pytorch python train.py $EXPERIMENT_NAME --gpu 0 1 2 3 4 5 6 7 -b $EXPT_BATCH_SIZE -w $EXPT_NUM_DATA_LOADERS -e $EXPT_NUM_EPOCHS --dlprof True --amp True;
